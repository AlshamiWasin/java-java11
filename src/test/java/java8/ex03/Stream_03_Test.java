...
public class Stream_03_Test {
	...
	public void test_max() throws Exception {
		...
		Optional<Order> result = orders.stream().max(Comparator.comparing( o1-> o1.getPrice()));
	...
	public void test_min() throws Exception {
		...
		Optional<Order> result = orders.stream().min(Comparator.comparing( o1-> o1.getPrice()));
	...
	public void test_map_collect_joining() throws Exception {
		...
		// par le caractère "|"
		String result = customers.stream().map(customer -> customer.getFirstname() ).sorted().collect(joining("|"));
