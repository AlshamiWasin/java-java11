...
public class Stream_02_Test {
	...
	public void test_map() throws Exception {
		...
		List<Customer> result = orders.stream().map(order -> order.getCustomer()).collect(Collectors.toList());
	...
	public void test_mapToDouble_sum() throws Exception {
		 ...
		 * commandes)
		 */
		double result = orders.stream().mapToDouble(price -> price.getPrice()).sum();
	...
	public void test_mapToDouble_avg() throws Exception {
		 ...
		 */
		OptionalDouble result = orders.stream().mapToDouble(price -> price.getPrice()).average();
