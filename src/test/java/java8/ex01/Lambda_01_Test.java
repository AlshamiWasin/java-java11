...
public class Lambda_01_Test {
    ...
    public void test_filter_by_age() throws Exception {
        ...
        PersonPredicate personPredicate = (p) -> p.getAge() >=18;
    ...
    public void test_filter_by_password() throws Exception {
        ...
        PersonPredicate personPredicate = (p) -> p.getAge() >49 && DigestUtils.sha512Hex(p.getPassword()).equals(passwordSha512Hex)  ;
